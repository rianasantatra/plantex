...
function toggleItem(item) {
  accordionItems.forEach((otherItem) => {
    if (otherItem !== item && otherItem.classList.contains("accordion_open")) {
      const otherItemContent = otherItem.querySelector(".questions_content");
      otherItemContent.removeAttribute("style");
